const PublicMain = () => import("../components/public/main");
const PublicHome = () => import("../components/public/home");
const About = () => import("../components/public/about");

const AdminLogin = () => import("../components/admin/login");
const AdminMain = () => import("../components/admin/main");
