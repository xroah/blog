<template>
    <section class="add-edit-article">
        <div class="form-flex">
            ...
            <input type="text" class="v-input form-control">
        </div>
        <div class="form-flex">
            <span class="form-label">文章分类:</span>
            <select type="text" class="v-input form-control">
                <option 
        ...
        <div class="form-flex flex-start">
            ...
            <div class="form-control content-editor">
                <div ref="toolbar">
...
export default {
    ...
    mounted() {
        ...
        toolbar.addHandler("image", () => alert(11111));
        window.quill = editor;
    },
    methods: {}
};
